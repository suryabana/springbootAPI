...
public class RadiologyController {
	...
	public ResponseEntity<radiologistGetResp> getScans(@RequestHeader(name = WebConstants.USER_AUTH_TOKEN) String AUTH_TOKEN,
		...
		if (!Validator.isStringEmpty(AUTH_TOKEN) && jwtutil.checkToken(AUTH_TOKEN,WebConstants.USER_RADIOLOGIST) != null && !Validator.isStringEmpty(id)) {
			try {
	...
	public ResponseEntity<testPostResponse> saveScanReport(@RequestHeader(name = WebConstants.USER_AUTH_TOKEN) String AUTH_TOKEN,
		...
		if (!Validator.isStringEmpty(AUTH_TOKEN) && jwtutil.checkToken(AUTH_TOKEN,WebConstants.USER_RADIOLOGIST) != null && !Validator.isEmptyTestPostRequest(scanReport)) {
			try {
